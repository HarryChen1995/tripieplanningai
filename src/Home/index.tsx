          ...
          {[
            {
              ...
              description: "Intelligent route optimization and location suggestions based on your preferences"
            },
            {
              icon: "bi-calendar-check",
              title: "Personalized Itineraries",
              description: "Custom travel plans tailored to your interests and travel style"
            },
            {
              icon: "bi-lightning-charge-fill",
              title: "Instant Recommendations",
              description: "Get real-time suggestions for activities, restaurants, and attractions"
            }
          ].map((feature, index) => (
            <motion.div 
              key={index}
